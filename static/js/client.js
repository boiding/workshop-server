	...
	return A2(
		_elm_lang$html$Html$div,
		{
			...
			_0: _elm_lang$html$Html_Attributes$classList(
				{
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'team', _1: true},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'disconnected', _1: !team.connected},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'connected', _1: team.connected},
							_1: {ctor: '[]'}
						}
					}
				}),
...
var _boiding$workshop_server$Domain$decodeTeam = A3(
	...
	A3(
		...
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_boiding$workshop_server$Domain$Team)));
var _boiding$workshop_server$Domain$decodeTeams = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'teams',
	_elm_lang$core$Json_Decode$dict(_boiding$workshop_server$Domain$decodeTeam),
...
var _boiding$workshop_server$Boiding$init = function (flags) {
	var teams = A3(
		...
		{name: 'yellow-nijmegen-whale', connected: false},
		A3(
			_elm_lang$core$Dict$insert,
			'red-bergen-crab',
			{name: 'red-bergen-crab', connected: true},
			_elm_lang$core$Dict$empty));
	return {
		ctor: '_Tuple2',
		_0: {
...
var _boiding$workshop_server$Boiding$subscriptions = function (model) {
	return A2(_elm_lang$websocket$WebSocket$listen, model.socket_address, _boiding$workshop_server$Boiding$Update);
};
var _boiding$workshop_server$Boiding$main = _elm_lang$html$Html$programWithFlags(
	{init: _boiding$workshop_server$Boiding$init, view: _boiding$workshop_server$Boiding$view, update: _boiding$workshop_server$Boiding$update, subscriptions: _boiding$workshop_server$Boiding$subscriptions})(
	A2(
		_elm_lang$core$Json_Decode$andThen,
		...
		A2(_elm_lang$core$Json_Decode$field, 'socket_address', _elm_lang$core$Json_Decode$string)));

var Elm = {};
Elm['Boiding'] = Elm['Boiding'] || {};
if (typeof _boiding$workshop_server$Boiding$main !== 'undefined') {
    _boiding$workshop_server$Boiding$main(Elm['Boiding'], 'Boiding', undefined);
}
