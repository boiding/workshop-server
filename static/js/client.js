...
var author$project$Boiding$init = function (_n0) {
	var teams = A3(
	...
	return _Utils_Tuple2(
		{
			error_message: elm$core$Maybe$Nothing,
...
var author$project$Boiding$update = F2(
	function (message, model) {
		...
		var next_model = function () {
			var _n1 = A2(elm$json$Json$Decode$decodeString, author$project$Domain$decodeTeams, updateMessage);
			if (_n1.$ === 'Ok') {
				var teams = _n1.a;
				...
				return _Utils_update(
					model,
					{
						error_message: elm$core$Maybe$Just(
							elm$json$Json$Decode$errorToString(error))
					});
			}
		}();
...
var author$project$Domain$viewTeam = function (team) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						_Utils_Tuple2('disconnected', !team.connected),
						_Utils_Tuple2('connected', team.connected)
					]))
			]),
		_List_fromArray(
			[
...
var author$project$Boiding$view = function (model) {
	var teams = A2(
		elm$core$List$map,
		author$project$Domain$viewTeam,
		elm$core$Dict$values(model.team_repository.teams));
	var error_message = A2(elm$core$Maybe$withDefault, '', model.error_message);
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
...
var author$project$Boiding$main = elm$browser$Browser$element(
	{init: author$project$Boiding$init, subscriptions: author$project$Boiding$subscriptions, update: author$project$Boiding$update, view: author$project$Boiding$view});
